...
void testy(void) {
	...
	while (1) {
		...
		STEP( 1)
			CREATE_PROCESS( "test1c_b", test1x, PRIORITY1C, &Z502_REG_4,
					&Z502_REG_9);

		STEP( 2)
			CREATE_PROCESS( "test1c_c", test1x, PRIORITY1C, &Z502_REG_5,
					&Z502_REG_9);
...
void get_skewed_random_number(long *random_number, long range) {
	...
	double temp;
	temp  = pow(range, (double) (1 / SKEWING_FACTOR));
